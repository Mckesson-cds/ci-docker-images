...
RUN wget -nv https://packages.chef.io/files/stable/chefdk/$CHEF_VERSION/ubuntu/18.04/chefdk_$CHEF_VERSION-1_amd64.deb
RUN dpkg -i ./chefdk_$CHEF_VERSION-1_amd64.deb
